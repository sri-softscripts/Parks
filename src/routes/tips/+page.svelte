<script lang="ts">
  ...
  import { tipsHotspots } from "$lib/data/tipsHotspots.ts";
  ...
  onMount(() => {
    ...
    bgTexture = textureLoader.load("/images/tips-background.png"); // Update with your image path
  ...
  const prev = () => activeIndex = (activeIndex - 1 + tipsHotspots.length) % tipsHotspots.length;
        ...
        <div class="page-header">
          ...
          <div class="page-blurb">
            <p>
              ...
              tips that can reduce noise emissions and increase visitor engagement
              and enjoyment of acoustic resources.
            </p>
          </div>
        </div>
...
<style>
  ...
  .tips .page-header {
   ...
   /*  background-color: #ccc;  */
    ...
    .tips .page-header .sub-title {
      font-size: 15px;
      font-weight: bold;
      letter-spacing: 1px;
      text-align: center;
      margin: 0px; }
    .tips .page-header .blurb-desc {
      text-shadow: 0px 3px 15px rgba(0, 0, 0, 0.85);
      margin-top: 1.5em; }
    .tips .page-header .page-blurb {
      font-size: 16px;
      line-height: 22px;
      max-width: 570px;
      margin: 0 auto;
      ...
      .tips .info-panel .content-wrapper .upper-content {
        ...
        .tips .info-panel .content-wrapper .upper-content ul {
          ...
          .tips .info-panel .content-wrapper .upper-content ul li {
            ...
            .tips .info-panel .content-wrapper .upper-content ul li.active.icon-habitat-patterns {
              color: #2970C0;
              background-color: #2970C0; }
            .tips .info-panel .content-wrapper .upper-content ul li.active.icon-hunting {
              color: #ffe385;
              background-color: #ffe385; }
            .tips .info-panel .content-wrapper .upper-content ul li.active.icon-predator-avoidance {
              color: #509917;
          ...
          .tips .info-panel .content-wrapper .lower-content .third.back {
            ...
            .tips .info-panel .content-wrapper .lower-content .third.back button {
              ...
              .tips .info-panel .content-wrapper .lower-content .third.back button img {
                ...
                height: 18px;
                margin-bottom: 10px; }
          .tips .info-panel .content-wrapper .lower-content .third button.progress-button {
            display: block;
            position: relative;
            width: 100%;
            height: 100%;
            ...
            border: 0px;
            outline: 0px; }
            .tips .info-panel .content-wrapper .lower-content .third button.progress-button .control {
              position: absolute;
              display: -webkit-box;
              display: -ms-flexbox;
              display: flex;
              ...
              -webkit-box-pack: center;
                  -ms-flex-pack: center;
                      justify-content: center; }
              .tips .info-panel .content-wrapper .lower-content .third button.progress-button .control img {
                position: relative;
                display: block;
                width: 16px;
                height: 33px; }
