...
<div class="page-header">
  ...
  <div class="page-blurb">
    <p>
      Learn from park employees and scientists about soundscape management tips
      that can reduce noise emissions and increase visitor engagement and
...
{#if hoveredMesh}
  <div class="hotspot-text" style="top:{labelY}px; left:{labelX}px">
          ...
          <div class="lower-content">
            <div class="third back-to-panolens">
              <button class="btn-pano-close" on:click={closePanel}>
                <img loading="lazy" src="/icons/back-360.svg" alt="" /> Back to 360°
                Experience
              </button>
            </div>
            <div class="third">
...
<style>
  ...
  #maintenance .tips-full-col,
  #framework .tips-full-col {
    flex-direction: column;
  }

  #maintenance .photo-wrapper,
  #engage .photo-wrapper,
  #zoning .photo-wrapper {
    width: 47%;
  }

  #maintenance .content-wrapper,
  #engage .content-wrapper,
...
#tips .page-inner:has(.summary-pannel.active) {
  position: relative;
  z-index: 50040;
}

#tips .page-inner:has(.summary-pannel.active)::before {
  content: "";
  position: fixed;
  inset: 0;
  background: rgba(0, 0, 0, 0.75);
  ...
  .summary-footer .third .close-summary img {
    max-width: 20px;
  ...
  #tips .page-inner:has(.summary-pannel.active) .info-panel {
