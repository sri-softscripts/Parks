...
<script lang="ts">
  ...
  export let nextPage = '/physics-of-sound'; // Default page for arrow link
...
// export let background = '#000';
  ...
  async function handlePageTransition(event: MouseEvent) {
    event.preventDefault();
    const url = (event.currentTarget as HTMLAnchorElement)?.getAttribute('href') || nextPage;
    exiting = true;
