  ...
  <div class="page-content">
    <div class="spectrogram-tips" id="spectrogram-section-1-tips">
      ...
      <div class="spectrogram-tips__item">
        ...
        <div class="spectrogram-tips__item-text">
          Did you hear the lizard? If you missed it, listen to the clip below
          and see if you can hear it again.<br /><br /><a
            href="#trigger-forest"
            class="listen-tip">Listen</a
          >
        </div>
      </div>
    </div>
    <div class="spectrogram-tips" id="spectrogram-section-3-tips">
      <div class="spectrogram-tips__item">
        ...
        <div class="spectrogram-tips__item-text">
          Can you still hear the coyote howling when one of the noises are
          clicked?
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <header class="page-header">
          ...
          <div class="sub-title">
            ...
            measurements. Acoustic spectrograms have three axes: <strong
              >time, frequency, and intensity</strong
            >.
          </div>
        </header>
      </div>
    ...
    <div class="spectrogram-section" id="spectrogram-section-1">
      <div class="container">
        <div class="spectrogram-header">
          ...
          <div class="sub-title">
            Composed of the natural sound conditions in a park that exist in the
            absence of any human-made noise.
          </div>
        </div>
        ...
        <div class="spectrogram-set" style="height: 600px;">
          ...
          {:else}
            ...
            <div
              style="width: 100%; height: 100%; background: #000; display: flex; align-items: center; justify-content: center; color: white;"
            >
          ...
          {#if isLoading}
            <div class="music-box__modal">
              <div class="music-box__modal__message">
                <div class="music-box__modal__message__text">
