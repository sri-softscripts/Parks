            ...
            <div class="spectrogram-section" id="spectrogram-section-3">
              <div class="container">
                <div class="spectrogram-header">
                  <!--                        <button class="button button-up move-to-previous" type="button" name="button" data-parent="spectrogram-masking" data-target="spectrogram-noise"><img loading="lazy" src="assets/images/arrow-up.svg" width="22" height="11" alt=""></button>  -->
                ...
                <div class="spectrogram-action">
                  <div class="spectrogram-container">
                    ...
                    <div class="spectrogram-buttons">
                      <div
                        data-name="Forest"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Crickets.mp3"
                        data-top-mix="Crickets"
                      ...
                      <div
                        data-name="Desert"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Coyote.mp3"
                        data-top-mix="Coyote"
                        class="spectrogram-button"
                      >
                        <div class="spectrogram-button-icon">
                      ...
                      <div
                        data-name="Lake"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Alligator.mp3"
                        data-top-mix="Alligator"
                        class="spectrogram-button"
                      >
                        <div class="spectrogram-button-icon">
                          <img
                  ...
                  <div class="spectrogram-container">
                    ...
                    <div class="spectrogram-buttons">
                      <div
                        data-name="Boat"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Boat.mp3"
                        data-bottom-mix="Boat"
                        class="spectrogram-button"
                      >
                        <div class="spectrogram-button-icon">
                          <img
                      ...
                      <div
                        data-name="Car"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Car.mp3"
                        data-bottom-mix="Car"
                        class="spectrogram-button"
                      >
                        <div class="spectrogram-button-icon">
                      ...
                      <div
                        data-name="Airplane"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Plane.mp3"
                        data-bottom-mix="Plane"
                        class="spectrogram-button"
                      >
                        <div class="spectrogram-button-icon">
                          <img
                      ...
                      <div
                        data-name="Thunder"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Thunder.mp3"
                        data-bottom-mix="Thunder"
                        class="spectrogram-button"
                      >
                        <div class="spectrogram-button-icon">
                          <img
                      ...
                      <div
                        data-name="Visitors"
                        data-src="/web/20250815031604oe_/http://parks.hikercompany.com/assets/sounds/spectrogram/Visitors.mp3"
                        data-bottom-mix="Visitors"
                        class="spectrogram-button"
                      >
                        <div class="spectrogram-button-icon">
                          <img
                ...
                <div class="pagnation-blk">
                  <button
                    ...
                    <span>Previous: Masking</span></button
                  >
                </div>
              </div>
            </div>
